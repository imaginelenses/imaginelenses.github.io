...
seo_title: 'Git Version Control for Blender & Non-Textual Files | Blendit Project'
tags:
    - 'version control'
    - 'project'
    - 'blender'
description: "How I built Blendit, an open-source 130-star Git version control extension for Blender. Learn how I solved versioning for non-textual graphical files by mapping function calls."
---
